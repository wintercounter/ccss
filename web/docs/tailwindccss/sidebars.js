...
module.exports = {
    docs: {
        ...
        'Core Concepts': [
            ...
            'core-concepts/functions-directives'
        ],
        Customization: [
        ...
        Spacing: ['spacing/padding', 'spacing/margin', 'spacing/space-between'],
        Sizing: [
            'sizing/width',
            'sizing/minwidth',
            'sizing/maxwidth',
        ...
        SVG: ['svg/fill', 'svg/stroke', 'svg/stroke-width'],
        Accessibility: ['accessibility/screen-readers'],
        'Official Plugins': ['official-plugins/typography']
    }
}
